...
var UserWhere = struct {
	...
	NickName:  whereHelperstring{field: "`user`.`nick_name`"},
...
var (
	userAllColumns            = []string{"id", "username", "password", "nick_name", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "password", "nick_name"}
...
func (q userQuery) UpdateAllGP(cols M) int64 {
...
func (q userQuery) DeleteAllGP() int64 {
